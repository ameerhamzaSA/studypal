  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header
        ...
        middleComponent={<Text style={{color: 'white', fontSize: _font(17)}}>PENDING DIARIES</Text>}
      ...
      <View style={{flex: 1, alignItems: 'center'}}>
        <FlatList
          ...
          renderItem={({item, index}) => {
            return (
              <Document color={colours.red} onClick={() => goToWizard(item.id)} item={item} image={images.right_arrow}/>
            );
          }
          }
        />
